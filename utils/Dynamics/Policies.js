...
async function GetPolicyResponses(token, employeeId) {
  ...
  var config = {
    method: "get",
    url: `https://${process.env.DYNAMICS_ENV}.api.crm11.dynamics.com/api/data/v9.2/pobl_policydocumentresponses?$filter=_pobl_responseemployeeid_value eq '${employeeId}' and pobl_responsesigned eq false and statecode eq 0`,
    headers: {
